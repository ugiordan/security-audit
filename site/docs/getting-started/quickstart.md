...
```bash
opencode run "Run the security audit skill on opendatahub-io/kube-auth-proxy"
```
...
[14:22:01] [INFO] Output: output/kube-auth-proxy/2026-06-04-142201
[14:22:01] [INFO] Sandbox: enabled
[14:22:01] [INFO] Container runtime: podman
[14:22:01] [INFO] Step 1: Init (opendatahub-io/kube-auth-proxy -> output/kube-auth-proxy/2026-06-04-142201)
...
[14:28:36] [INFO] Reports in: output/kube-auth-proxy/2026-06-04-142201/
...
```
output/kube-auth-proxy/2026-06-04-142201/
...
```bash
open output/kube-auth-proxy/2026-06-04-142201/security-report.html
```
...
```bash
open output/kube-auth-proxy/2026-06-04-142201/security-report.docx
```
...
```bash
cd output/kube-auth-proxy/2026-06-04-142201/report-site
